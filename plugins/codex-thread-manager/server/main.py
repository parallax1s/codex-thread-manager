...
SERVER_NAME = "codex-thread-manager"
...
def _make_services() -> tuple[ThreadStore, ConfigStore, CodexAppController]:
...
def _handle_tool_call(name: str, args: dict[str, Any]) -> dict[str, Any]:
    thread_store, config_store, app_controller = _make_services()
